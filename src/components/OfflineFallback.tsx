...
const OfflineFallback: React.FC<OfflineFallbackProps> = ({requestedUrl, fallbackType = 'page', onRetry}) => {
    ...
    const getFallbackContent = () => {
        ...
        case 'content':
            return {
                ...
                description: cachedContent ? 'This content is cached but failed to load. Try refreshing the page.' : 'This content hasn\'t been cached for offline viewing yet.',
