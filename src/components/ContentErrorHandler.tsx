 ...
 */
const ContentErrorHandler: React.FC<ContentErrorHandlerProps> = ({error, contentType = 'generic', requestedUrl, fallbackContent, onRetry, onFallback, children}) => {
        ...
        if (!networkStatus.isOnline) {
            ...
            case 'page':
                return {
                    ...
                    description: cachedContent ? 'This page is cached but failed to load. Try refreshing.' : 'This page hasn\'t been cached for offline viewing yet.',
                };
        ...
        return (
            <div className="flex flex-col items-center justify-center p-8 text-center">
                ...
                <div className="mb-4 flex items-center text-sm text-gray-500 dark:text-gray-400">
                    <div
                            className={`w-2 h-2 rounded-full mr-2 ${networkStatus.isOnline ? 'bg-green-500' : 'bg-red-500'}`}
                        />
