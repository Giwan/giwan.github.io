...
const NetworkErrorHandler: React.FC<NetworkErrorHandlerProps> = ({error, url, onRetry, onSuccess, retryConfig, children}) => {
    ...
    const getErrorMessage = (errorType: string): {
        ...
        case 'network':
            return {
                ...
                description: networkStatus.isOnline ? 'Unable to reach the server. This might be a temporary issue.' : 'You appear to be offline. Check your internet connection.',
            };
