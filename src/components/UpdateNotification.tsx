...
const UpdateNotification: React.FC<UpdateNotificationProps> = ({onUpdate, onDismiss, isVisible}) => {
    ...
    return (
        <div
            className={`fixed bottom-4 right-4 z-50 max-w-sm transition-all duration-300 ease-in-out ${isAnimating ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`}
            role="alert"
            aria-live="polite"
