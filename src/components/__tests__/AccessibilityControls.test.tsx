...
describe('AccessibilityControls', () => {
    it('should render the toggle button', () => {
        ...
        const toggleButton = screen.getByRole('button', {
            name: /open accessibility controls/i,
        });
    ...
    it('should toggle screen reader announcements when button is clicked', () => {
        ...
        const screenReaderButton = screen.getByRole('button', {
            name: /disable screen reader announcements/i,
        });
    ...
    it('should toggle focus management when button is clicked', () => {
        ...
        const focusManagementButton = screen.getByRole('button', {
            name: /disable focus management/i,
        });
    ...
    it('should toggle keyboard navigation when button is clicked', () => {
        ...
        const keyboardNavButton = screen.getByRole('button', {
            name: /disable keyboard navigation enhancements/i,
        });
    ...
    it('should reflect current preference states in button labels', () => {
        ...
        expect(screen.getByRole('button', {
            name: /disable reduced motion/i,
        })).toBeInTheDocument();
        expect(screen.getByRole('button', {
            name: /enable screen reader announcements/i,
        })).toBeInTheDocument();
        expect(screen.getByRole('button', {
            name: /disable focus management/i,
        })).toBeInTheDocument();
        expect(screen.getByRole('button', {
            name: /enable keyboard navigation enhancements/i,
        })).toBeInTheDocument();
    });
});
