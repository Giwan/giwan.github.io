...
describe('AccessibilityManager', () => {
    describe('initialization', () => {
        ...
        it('should setup event listeners', () => {
            ...
            expect(mockAddEventListener).toHaveBeenCalledWith('astro:before-preparation', expect.any(Function));
            expect(mockAddEventListener).toHaveBeenCalledWith('astro:after-swap', expect.any(Function));
            expect(mockAddEventListener).toHaveBeenCalledWith('astro:page-load', expect.any(Function));
        });
    });
    ...
    describe('preferences management', () => {
        it('should update preferences', () => {
            ...
            const preferences = manager.getPreferences();
            expect(preferences.reducedMotion).toBe(true);
            expect(mockLocalStorage.setItem).toHaveBeenCalledWith('accessibility-preferences', expect.stringContaining('"reducedMotion":true'));
        });
    ...
    describe('keyboard navigation', () => {
        it('should skip to main content when requested', () => {
            ...
            expect(mockMainContent.setAttribute).toHaveBeenCalledWith('tabindex', '-1');
            expect(mockMainContent.focus).toHaveBeenCalled();
            expect(mockMainContent.scrollIntoView).toHaveBeenCalledWith({
                behavior: 'smooth',
            });
        });
