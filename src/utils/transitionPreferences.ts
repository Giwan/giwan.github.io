...
export class TransitionPreferencesManager {
   ...
   */
    private setupReducedMotionListener(): void {
        ...
        this.mediaQueryList = globalThis.matchMedia('(prefers-reduced-motion: reduce)');
   ...
   */
    public getPreference<K extends keyof TransitionPreferences>(key: K): TransitionPreferences[K] {
        return this.preferences[key];
    }
    /**
   * Update a specific preference
   */
    public updatePreference<K extends keyof TransitionPreferences>(key: K, value: TransitionPreferences[K]): void {
   ...
   */
    private applyPreferences(): void {
        ...
        if (this.preferences.respectReducedMotion && globalThis.matchMedia('(prefers-reduced-motion: reduce)').matches)
   ...
   */
    public getEffectiveIntensity(): TransitionIntensity {
        ...
        if (this.preferences.respectReducedMotion && globalThis.matchMedia && globalThis.matchMedia('(prefers-reduced-motion: reduce)').matches)
    ...
    public destroy(): void {
        if (this.mediaQueryList) {
            if (this.mediaQueryList.removeEventListener)
                this.mediaQueryList.removeEventListener('change', noop);
            else
                this.mediaQueryList.removeListener(noop);
