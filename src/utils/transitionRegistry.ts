...
export class TransitionRegistry {
   ...
   */
    private initializeDefaultPatterns(): void {
        ...
        this.routePatterns = [        // Blog patterns
{
            pattern: /^\/blog\/[\w-]+\/$/,
            ...
            pattern: /^\/blog\/?$/,
            pageType: PageType.BLOG_LIST,
            priority: 90,
        },         // Tools patterns
{
            pattern: /^\/tools\/[^\/]+\/?$/,
            pageType: PageType.TOOLS_CATEGORY,
            priority: 100,
        }, {
            pattern: /^\/tools\/?$/,
            pageType: PageType.TOOLS_LIST,
            priority: 90,
        },         // Search patterns
{
            pattern: /^\/search/,
        ...
        },         // Home page (should be last due to broad matching)
{
   ...
   */
    registerPageType(route: string, type: PageType): void {
        const metadata: PageMetadata = {
            ...
            childRoutes: this.findChildRoutes(),
        };
   ...
   */
    getPageRelationship(fromType: PageType, toType: PageType): PageRelationship {
   ...
   */
    private selectTransitionName(context: NavigationContext): string {
        ...
        if (relationship === PageRelationship.PARENT_CHILD) {
            ...
            const isListToDetail = ((fromPageType === PageType.BLOG_LIST && toPageType === PageType.BLOG_POST)
   ...
   */
    private findChildRoutes(): string[] {
