...
| :--- | :--- | :--- | :--- |
| **AI-First IDEs** | | | |
| **Cursor** | "Composer" (multi-file edits) | $20/mo | The "Gold Standard" for AI IDEs. |
| **Windsurf** | "Cascade" engine & Codemaps | $15/mo | Deep context in large codebases. |
| **Agentic CLIs** | | | |
| **Claude Code** | Terminal-native agent | $20-$200/mo | Fast, autonomous CLI workflows. |
| **Gemini CLI** | ReAct loop & 1M context | Free / Usage-based | Deep research and massive analysis. |
| **Mistral Vibe** 🇪🇺 | Minimalist "vibe-coding" | Usage-based | Open-source, EU-based workflows. |
...
- **Mistral Vibe** 🇪🇺: France's Mistral AI has entered the fray with a minimalist, open-source (Apache 2.0) CLI agent. For developers concerned about data sovereignty and European hosting, Vibe combined with Mistral's EU-based infrastructure is becoming a strong alternative to US-based incumbents.
...
- **OpenRouter Apps:** Explore the [OpenRouter Apps gallery](https://openrouter.ai/apps) to discover dozens of other LLM-powered developer tools and interfaces.
