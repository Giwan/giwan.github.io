---
description: "The uncanny valley is time needed for browsers to process JS code and build your application"
...
It's wasteful in many ways. There is unnecessary network transfer and CPU processing. Obviously it's also very wasteful for your battery.
