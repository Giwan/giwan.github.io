---
description: "Store your resume in a JSON doc and then apply various styles to it"
...
Whenever it's time to update your resume, it's always a bit of a hassle. It's always a combination of styling and data. Why not separate the data from the style.
...
Yes your resume online is also mineable. However, I'm not sure that the benefits that resume.json offers enough benefits for this trade-off.
